...
class DuMatoCPU {
    public:
        ...
        DuMatoCPU(const char *datasetName, int k, int numberOfActiveThreads, int blockSize, int numberOfSMs, int jobsPerWarp, void (*kernel)(DataGPU*), int globalThreshold, bool relabeling, int virtualWarpSize);
        void runKernel();
        void waitKernel();
    ...
    private:
        ...
        void initializeCpuDataStructures(unsigned int virtualWarpSize);
